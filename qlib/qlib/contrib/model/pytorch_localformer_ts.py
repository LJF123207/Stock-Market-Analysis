    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.logger.info(
            ...
            "\nfusion_type : {}"
            "\nlayer_num : {}"
            "\nd_news : {}".format(self.batch_size, self.device, self.usenews, self.fusion_type, self.layer_num, self.news_dim)
        )
...
class Transformer(nn.Module):
    def __init__(self, d_feat=6, d_model=8, nhead=4, num_layers=2, dropout=0.5, device=None, d_news=0, use_news=False, fusion_type="add", layer_num=2):
        ...
        self.fusion_proj = nn.Linear(d_news + d_feat, d_feat) if self.use_news and self.fusion_type == "concat" else None
    ...
    def forward(self, src):
        ...
        src = self.feature_layer(feat)  # [512, 60, 8]
